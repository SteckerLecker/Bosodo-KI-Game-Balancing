...
echo ""
echo "Download balancing_report.json (lokal auf deinem Mac ausfuehren, nicht im Container):"
echo "scp -P 22122 ps-stud5@141.39.193.212:~/data/stud5/output/reports/balancing_report.json ./output/reports/"
