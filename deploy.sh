...
echo "   python /app/scripts/iterative_balance.py"
echo "   (Arbeitsverzeichnis ist /proj = gemountetes Volume, Output landet dort)"
echo ""
echo "   Optionen:"
echo "   python /app/scripts/iterative_balance.py --timesteps 1000000 --max-iterations 15"
echo "   python /app/scripts/iterative_balance.py --start-version 3   # Ab Version 3 weitermachen"
echo "   python /app/scripts/iterative_balance.py --work-dir /proj    # Explizit Work-Dir setzen"
echo ""
...
echo "   scp -P 22122 ps-stud5@141.39.193.212:~/data/stud5/output/iterative_balancing/summary.json ./results/"
echo "   scp -r -P 22122 ps-stud5@141.39.193.212:~/data/stud5/output/iterative_balancing/ ./results/"
echo "   scp -r -P 22122 \"ps-stud5@141.39.193.212:~/data/stud5/data_v*\" ./"
echo "   scp -P 22122 ps-stud5@141.39.193.212:~/data/stud5/output/reports/balancing_report.json ./reports/"
echo "============================================================"